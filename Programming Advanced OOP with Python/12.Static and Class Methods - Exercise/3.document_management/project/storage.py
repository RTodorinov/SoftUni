...
class Storage:
    ...
    @staticmethod  # създаваме статик за да се ползва от всички функции надолу за да не повтаряме код
    def __find_object(object_id, object_collection):
        return next((obj for obj in object_collection if obj.id == object_id), None)
        # ако next намери съвпадение спира до там и не продължава да итерира
