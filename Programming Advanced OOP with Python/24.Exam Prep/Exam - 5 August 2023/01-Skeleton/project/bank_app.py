...
class BankApp:
    # possible_loans = {"StudentLoan": StudentLoan, "MortgageLoan": MortgageLoan}
    ...
    def add_loan(self, loan_type: str):
        # if loan_type in self.possible_loans:
        #     loan = self.possible_loans[loan_type]()
    ...
    def grant_loan(self, loan_type: str, client_id: str):
        ...
        if (loan_type == "StudentLoan" and client.__class__.__name__ == "Student") or (
            ...
            loan = [lo for lo in self.loans if lo.__class__.__name__ == loan_type][0]
