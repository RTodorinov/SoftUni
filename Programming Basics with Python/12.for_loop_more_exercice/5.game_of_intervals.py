...
invalid, num1, num2, num3, num4, num5, final_score = 0, 0, 0, 0, 0, 0, 0
...
print(f"From 0 to 9: {(num1 /game_rounds) * 100:.2f}%")
print(f"From 10 to 19: {(num2 /game_rounds) * 100:.2f}%")
print(f"From 20 to 29: {(num3 /game_rounds) * 100:.2f}%")
print(f"From 30 to 39: {(num4 /game_rounds) * 100:.2f}%")
print(f"From 40 to 50: {(num5 /game_rounds) * 100:.2f}%")
print(f"Invalid numbers: {(invalid / game_rounds) * 100:.2f}%")
