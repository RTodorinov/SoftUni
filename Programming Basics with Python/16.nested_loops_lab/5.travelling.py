...
while True:
    destination = input()  # вкарваме дестинацията

    if destination == "End":  # проверяваме дали е командата "End" ако да прекъсваме цикъла
        break

    vacation_price = float(input())  # вкарваме цена на дестинацията
    current_money = 0  # добавяме променлива за спестените пари

    while vacation_price > current_money:  # слагаме нов цикъл в който оскаме да добавяме събраните
        current_money += float(input())    # пари от долу и когато станат повече принтираме.
