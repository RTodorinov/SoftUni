...
# (която е с отвор 160 cm) се губи точно 1 работно място, а заради катедрата
...
number_of_lines = w // 120
number_of_colons = (h - 100) // 70

total_work_place = number_of_colons * number_of_lines - 3

print(total_work_place)
