...
#     if title not in list_of_lessons:  # проверка ако заглавието не е в листа го добавяме
#         list_of_lessons.append(title)
#     return list_of_lessons
#
#
# def insert_lesson(list_of_lessons, title, index):
#     if title not in list_of_lessons:  # проверка ако заглавието не е в листа го инсъртваме на дадения индекс
#         list_of_lessons.insert(index, title)
#     return list_of_lessons
#
#
# def remove_lesson(list_of_lessons, title):
#     if title in list_of_lessons:  # проверка ако заглавието е в листа го изтриваме
...
#
#
# def swap_lesson(list_of_lessons, title, second_title):
#     if title in list_of_lessons and second_title in list_of_lessons:
#         # title[1], second_title[2] = second_title[2], title[1]
#         first_index = list_of_lessons.index(title)
#         second_index = list_of_lessons.index(second_title)
