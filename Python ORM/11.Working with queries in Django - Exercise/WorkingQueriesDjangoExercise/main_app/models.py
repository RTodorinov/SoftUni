...
class Meal(models.Model):
    ...
    meal_type = models.CharField(max_length=10, choices=MealTypeChoice)
...
class Dungeon(models.Model):
    name = models.CharField(max_length=100)
    difficulty = models.CharField(max_length=10, choices=DungeonDifficultyChoice)
...
class Workout(models.Model):
    ...
    workout_type = models.CharField(max_length=20, choices=WorkoutTypeChoice)
