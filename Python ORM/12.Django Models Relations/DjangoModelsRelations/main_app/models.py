...
class Subject(models.Model):
    ...
    lecturer = models.ForeignKey(to=Lecturer, on_delete=models.SET_NULL, null=True, blank=True)
...
class StudentEnrollment(models.Model):
    ...
    enrollment_date = models.DateField(default=date.today)  # auto_now_add=True
