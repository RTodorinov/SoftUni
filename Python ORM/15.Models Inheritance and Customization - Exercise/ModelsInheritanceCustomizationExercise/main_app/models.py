...
class Message(models.Model):
    ...
    timestamp = models.DateTimeField(
        auto_now_add=True,  # only once we add date when we create record in the base
    )                       # auto_now we record new date everytime when we create record in the base
...
class MaskedCreditCardField(models.CharField):
    def __init__(self, *args, **kwargs):
        kwargs["max_length"] = 20  # {max_length: 20}
