...
class Product(models.Model):
    ...
    def calculate_tax(self) -> Decimal:
        return self.price * Decimal(0.08)  # returns the tax for the product. The tax rate is 8% of the price

    @staticmethod
    def calculate_shipping_cost(weight: Decimal) -> Decimal:
        return weight * Decimal(2.00)  # The shipping cost is the weight units of the product multiplied by 2.00
...
class DiscountedProduct(Product):
    ...
    def calculate_price_without_discount(self) -> Decimal:
        return self.price * Decimal(1.20)  # The original price is 20% higher than the price without a discount

    def calculate_tax(self) -> Decimal:  # returns the tax for the product. The tax rate is 5% of the price
