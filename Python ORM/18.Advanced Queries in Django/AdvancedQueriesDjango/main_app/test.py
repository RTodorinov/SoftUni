...
from caller import ordered_products_per_customer
...
class OrderedProductsPerCustomerTestCase(TestCase):
    ...
    def test_practice_test(self):
        result = ordered_products_per_customer()
        self.assertEqual(result.strip(), """Order ID: 1, Customer: john_doe
- Product: Apples, Category: Food
- Product: Tomatoes, Category: Food
- Product: Carton of Eggs, Category: Food
- Product: Orange Soda, Category: Drinks
Order ID: 2, Customer: peter132
- Product: Apples, Category: Food
- Product:  Milk, Category: Food
Order ID: 3, Customer: john_doe
- Product: Bottled Water, Category: Drinks
- Product: Carton of Eggs, Category: Food""")
